...
import com.teamcenter.soa.input.PasswordField;
 ...
 * will send the SessionService.login service request. Upon successfull
...
public class AppXCredentialManager implements CredentialManager {
	...
	public String[] promptForCredentials() throws CanceledOperationException {
		...
		name = PasswordField.readUserName("User Name: ");
